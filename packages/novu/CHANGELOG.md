...
- **novu:** Add `--studio-host` option on dev server ([#7211](https://github.com/khulnasoft/novu/pull/7211))
...
- **novu:** Respect .env values for API URL and SECRET_KEY ([#7279](https://github.com/khulnasoft/novu/pull/7279))
...
- **novu:** Add `--headless` flag to prevent automatic browser open with `npx novu dev` command ([#7016](https://github.com/khulnasoft/novu/pull/7016))
- **novu:** update novu init landing page ([#6805](https://github.com/khulnasoft/novu/pull/6805))
