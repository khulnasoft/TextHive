...
Before submitting a new issue, please search the existing [issues](https://github.com/khulnasoft/texthive/issues). Maybe an issue already exists and might inform you of workarounds. Otherwise, you can give new information.

While we want to fix all the [issues](https://github.com/khulnasoft/texthive/issues), before fixing a bug we need to be able to reproduce and confirm it. Please provide us with a minimal reproduction scenario using a repository or [Gist](https://gist.github.com/). Having a live, reproducible scenario gives us the information without asking questions back & forth with additional questions like:

- 3rd-party libraries being used and their versions (mainly providers, but not exclusively)
- a use-case that fails

Without said minimal reproduction, we won't be able to investigate all [issues](https://github.com/khulnasoft/texthive/issues), and the issue might not be resolved.

You can open a new issue with this [issue form](https://github.com/khulnasoft/texthive/issues/new).
...
If a feature is missing, you can directly _request_ a new one [here](https://github.com/khulnasoft/texthive/issues/new?assignees=&labels=feature&template=feature_request.yml&title=%F0%9F%9A%80+Feature%3A+). You also can do the same by choosing "🚀 Feature" when raising a [New Issue](https://github.com/khulnasoft/texthive/issues/new/choose) on our GitHub Repository.
...
Questions, suggestions, and thoughts are most welcome. Feel free to open a [GitHub Issue](https://github.com/khulnasoft/texthive/issues/new/choose). We can also be reached on our [Discord Server](https://discord.novu.co).

## Ways to contribute

- Try the Novu API and platform and give feedback
- Add new providers
- Help with open [issues](https://github.com/khulnasoft/texthive/issues) or [create your own](https://github.com/khulnasoft/texthive/issues/new/choose)
